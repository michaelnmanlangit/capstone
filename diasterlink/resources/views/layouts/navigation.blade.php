            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <span class="text-xl font-bold text-gray-800">DISASTERLINK</span>
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(auth()->user()->isResponder() || auth()->user()->isAdmin())
                        <x-nav-link :href="route('responder.incidents')" :active="request()->routeIs('responder.*')">
                            {{ __('Incidents') }}
                        </x-nav-link>
                    @endif
                    ...
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                            ...
                            <span class="ml-2 px-2 py-1 text-xs rounded-full 
                                ...
                                @elseif(auth()->user()->isResponder()) bg-yellow-100 text-yellow-800
